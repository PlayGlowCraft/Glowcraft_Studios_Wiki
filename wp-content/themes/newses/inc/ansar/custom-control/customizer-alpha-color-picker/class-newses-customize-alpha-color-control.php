...
/**
 * Class Newses_Customize_Alpha_Color_Control
 */
class Newses_Customize_Alpha_Color_Control extends WP_Customize_Control {
	/**
	...
	public function enqueue() {
		wp_enqueue_script(
			'newses_alpha-color-picker',
			get_template_directory_uri() . '/inc/ansar/custom-control/customizer-alpha-color-picker/js/alpha-color-picker.js',
			array( 'jquery', 'wp-color-picker' ),999,true
		);
		wp_enqueue_style(
			'newses_alpha-color-picker',
