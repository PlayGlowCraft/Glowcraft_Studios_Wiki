...
// Add term page
    function newsup_taxonomy_add_new_meta_field()
    {
        ...
        <div class="form-field">
            <label for="term_meta[color_class_term_meta]"><?php esc_html_e('Color Class', 'newsup'); ?></label>
            ...
            <p class="description"><?php esc_html_e('Select category color class. You can set appropriate categories color on "Categories" section of the theme customizer.', 'newsup'); ?></p>
        </div>
        <?php
    }
endif;
    ...
    function newsup_taxonomy_edit_meta_field($term)
    {
        ...
        <tr class="form-field">
            <th scope="row" valign="top"><label
                        for="term_meta[color_class_term_meta]"><?php esc_html_e('Color Class', 'newsup'); ?></label></th>
            <td>
                <?php
                $cat_color = array(
                    'category-color-1' => __('Category Color 1', 'newsup'),
