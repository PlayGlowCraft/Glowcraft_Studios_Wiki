		...
		foreach( $newsup_free_plugins as $newsup_plugin ) {
			...
			<div class="recom-plugin-wrap mb-0">
				<div class="plugin-title-install clearfix">
					...
					<a href="<?php echo esc_url( 'admin.php?page=ansar-demo-import' ); ?>"><?php echo esc_html('Ansar Demo Importer', 'newsup'); ?></a>
					<?php echo esc_html('theme demos in under ansar import menu.', 'newsup'); ?>
					...
					echo Newsup_Getting_Started_Page_Plugin_Helper::instance()->get_button_html( $newsup_plugin['slug'], array('redirect' => esc_url( admin_url('admin.php?page=ansar-demo-import') )) );
					echo '</div>';
					?>
				</div>
			</div>
