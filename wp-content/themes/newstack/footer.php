...
?>
  <div class="container-fluid mr-bot40 mg-posts-sec-inner">
        ...
        <div class="row">
            <?php $you_missed_title = get_theme_mod('you_missed_title', esc_html('You missed','newstack'));
            if($you_missed_title) { ?>
            <div class="col-md-12">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                          <?php $newsup_enable_footer_menu = esc_attr(get_theme_mod('newsup_enable_footer_menu','true'));
                            ...
                            <?php } ?>
<p>
GlowCraft Studios &copy; 2022–<?php echo esc_html( date_i18n( 'Y' ) ); ?><br>
<a href="/privacy-policy">Privacy Policy</a><br><br>
Not affiliated with Mojang AB or Microsoft.<br>
