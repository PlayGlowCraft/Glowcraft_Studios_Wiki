...
// ===== GlowCraft Login Branding =====

// Custom logo
function glowcraft_login_logo() {
    echo '<style type="text/css">
        ...
        .login form {
            ...
            border-radius: 10px;
            border: 1px solid rgba(240, 59, 2, 0.4);
            box-shadow: 0 0 15px rgba(240, 59, 2, 0.25);
        }
        ...
        .wp-core-ui .button-primary {
            background: #f03b02;
            border: none;
            box-shadow: 0 0 10px rgba(240, 59, 2, 0.4);
        }
...
add_action('login_head', 'glowcraft_login_logo');

// Logo link
function glowcraft_login_logo_url() {
    return home_url();
}
add_filter('login_headerurl', 'glowcraft_login_logo_url');

// Logo title
function glowcraft_login_logo_title() {
    return 'GlowCraft Studios';
}
add_filter('login_headertext', 'glowcraft_login_logo_title');